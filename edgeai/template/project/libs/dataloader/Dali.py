...
class DaliPipeline(dali.pipeline.Pipeline):
    ...
    def __init__(
        ...
        self.input = dali.ops.TFRecordReader(
            ...
            features={
                ...
                'file_name': dali.tfrecord.FixedLenFeature([], dali.tfrecord.string, ''),
            }
        )
        ...
        self.cast_float_gpu = dali.ops.Cast(dtype=dali.types.FLOAT, device="gpu")
    ...
    def define_graph(self):
        ...
        images = self.cast_float_gpu(images)
